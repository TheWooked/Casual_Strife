...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("CasualStrife", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("CasualStrife", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "CasualStrife";
		app.meta["name"] = "CasualStrife";
